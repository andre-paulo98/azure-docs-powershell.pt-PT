...
#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-111">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-111">AzureRM.Compute</span></span>
...
## <a name="6100---october-2018"></a><span data-ttu-id="ef6c9-126">6.10.0 - Outubro de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-126">6.10.0 - October 2018</span></span>
...
* <span data-ttu-id="ef6c9-140">Adição da funcionalidade NetworkProfile.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-140">Added NetworkProfile functionality.</span></span> <span data-ttu-id="ef6c9-141">novos cmdlets adicionados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-141">new cmdlets added</span></span>
    ...
    - <span data-ttu-id="ef6c9-147">New-AzureRmContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="ef6c9-147">New-AzureRmContainerNicConfigIpConfig</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-162">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-162">AzureRM.Websites</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-177">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-177">AzureRM.Compute</span></span>
...
* <span data-ttu-id="ef6c9-192">Alterações aos cmdlets LoadBalancer</span><span class="sxs-lookup"><span data-stu-id="ef6c9-192">Changes to LoadBalancer cmdlets</span></span>
  ...
  - <span data-ttu-id="ef6c9-196">LoadBalancerProbeConfig: suporte para o valor "Https" para o parâmetro Protocol adicionado</span><span class="sxs-lookup"><span data-stu-id="ef6c9-196">LoadBalancerProbeConfig: added support for value "Https" for parameter Protocol</span></span>
...
* <span data-ttu-id="ef6c9-215">Adicionado suporte para o certificado de raiz fidedigna e configuração de dimensionamento automático no Gateway de Aplicação</span><span class="sxs-lookup"><span data-stu-id="ef6c9-215">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  - <span data-ttu-id="ef6c9-216">Novos cmdlets adicionados:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-216">New Cmdlets added:</span></span>
      ...
      - <span data-ttu-id="ef6c9-221">Set-AzureRmApplicationGatewayTrustedRootCertificate</span><span class="sxs-lookup"><span data-stu-id="ef6c9-221">Set-AzureRmApplicationGatewayTrustedRootCertificate</span></span>
...
* <span data-ttu-id="ef6c9-235">Adicionado suporte para vários prefixos de endereços numa sub-rede.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-235">Added support for multiple address prefixes in a subnet.</span></span> <span data-ttu-id="ef6c9-236">cmdlets atualizados:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-236">Updated cmdlets:</span></span>
  ...
  - <span data-ttu-id="ef6c9-247">Set-AzureRmApplicationGatewayIPConfiguration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-247">Set-AzureRmApplicationGatewayIPConfiguration</span></span>
...
* <span data-ttu-id="ef6c9-270">Os parâmetros com valores predefinidos já não são necessários ao atribuir uma política com “New-AzureRmPolicyAssignment”</span><span class="sxs-lookup"><span data-stu-id="ef6c9-270">Parameters with default values are no longer requred when assigning a policy with 'New-AzureRmPolicyAssignment'</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-290">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-290">AzureRM.Websites</span></span>
...
* <span data-ttu-id="ef6c9-307">Problema https://github.com/Azure/azure-powershell/issues/6814 corrigido</span><span class="sxs-lookup"><span data-stu-id="ef6c9-307">Fixed issue https://github.com/Azure/azure-powershell/issues/6814</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="ef6c9-323">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="ef6c9-323">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermiothub"></a><span data-ttu-id="ef6c9-340">AzureRM.IotHub</span><span class="sxs-lookup"><span data-stu-id="ef6c9-340">AzureRM.IotHub</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-358">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-358">AzureRM.Websites</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="ef6c9-373">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="ef6c9-373">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermcognitiveservices"></a><span data-ttu-id="ef6c9-387">AzureRM.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="ef6c9-387">AzureRM.CognitiveServices</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="ef6c9-401">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="ef6c9-401">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventgrid"></a><span data-ttu-id="ef6c9-416">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="ef6c9-416">AzureRM.EventGrid</span></span>
...
#### <a name="azurermmachinelearningcompute"></a><span data-ttu-id="ef6c9-432">AzureRM.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-432">AzureRM.MachineLearningCompute</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="ef6c9-447">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="ef6c9-447">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermscheduler"></a><span data-ttu-id="ef6c9-484">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="ef6c9-484">AzureRM.Scheduler</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="ef6c9-486">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="ef6c9-486">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="ef6c9-487">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-487">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="ef6c9-488">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ef6c9-488">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="ef6c9-489">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-489">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="ef6c9-490">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-490">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-491">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-491">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="ef6c9-492">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-492">AzureRM.Storage</span></span>
* <span data-ttu-id="ef6c9-493">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-493">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermstreamanalytics"></a><span data-ttu-id="ef6c9-494">AzureRM.StreamAnalytics</span><span class="sxs-lookup"><span data-stu-id="ef6c9-494">AzureRM.StreamAnalytics</span></span>
* <span data-ttu-id="ef6c9-495">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-495">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="ef6c9-496">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="ef6c9-496">AzureRM.Tags</span></span>
* <span data-ttu-id="ef6c9-497">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-497">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="ef6c9-498">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="ef6c9-498">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="ef6c9-499">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-499">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermusageaggregates"></a><span data-ttu-id="ef6c9-500">AzureRM.UsageAggregates</span><span class="sxs-lookup"><span data-stu-id="ef6c9-500">AzureRM.UsageAggregates</span></span>
* <span data-ttu-id="ef6c9-501">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-501">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-502">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-502">AzureRM.Websites</span></span>
* <span data-ttu-id="ef6c9-503">Atualizado para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-503">Updated to the latest version of the Azure ClientRuntime.</span></span>

## <a name="660---july-2018"></a><span data-ttu-id="ef6c9-504">6.6.0 - Julho de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-504">6.6.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="ef6c9-505">Geral</span><span class="sxs-lookup"><span data-stu-id="ef6c9-505">General</span></span>
* <span data-ttu-id="ef6c9-506">Foram atualizados todos os ficheiros de ajuda para incluir tipos de parâmetros inteiros e tipos de entrada/saída corretos.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-506">Updated all help files to include full parameter types and correct input/output types.</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="ef6c9-507">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-507">AzureRM.Profile</span></span>
* <span data-ttu-id="ef6c9-508">A biblioteca Common.Strategy foi atualizada para poder validar que a configuração atual de um recurso é compatível com o recurso de destino.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-508">Updated Common.Strategy library to be able to validate that the current config for a resource is compatible with the target resource.</span></span>
* <span data-ttu-id="ef6c9-509">Foi adicionado ps1xml a Common.Storage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-509">Added ps1xml types to Common.Storage</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="ef6c9-510">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-510">Azure.Storage</span></span>
* <span data-ttu-id="ef6c9-511">Adicionado suporte para obter o Contexto de Armazenamento de DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-511">Added support for getting Storage Context from DefaultProfile</span></span>
* <span data-ttu-id="ef6c9-512">Adicionado Ps1XmlAttribute a propriedades de tipos de saídas de cmdlets.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-512">Added Ps1XmlAttribute to cmdlets output types properties.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="ef6c9-513">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="ef6c9-513">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="ef6c9-514">Problema https://github.com/Azure/azure-powershell/issues/6370 corrigido</span><span class="sxs-lookup"><span data-stu-id="ef6c9-514">Fixed issue https://github.com/Azure/azure-powershell/issues/6370</span></span>
    - <span data-ttu-id="ef6c9-515">Foi corrigido um erro no Automapper para traduzir PsApiManagementApi para ApiContract</span><span class="sxs-lookup"><span data-stu-id="ef6c9-515">Fixed bug in Automapper to translate PsApiManagementApi to ApiContract</span></span>
* <span data-ttu-id="ef6c9-516">Problema https://github.com/Azure/azure-powershell/issues/6515 corrigido</span><span class="sxs-lookup"><span data-stu-id="ef6c9-516">Fixed issue https://github.com/Azure/azure-powershell/issues/6515</span></span>
    - <span data-ttu-id="ef6c9-517">Foi corrigido um erro em File.Save para não sobrecarregar com Tipo de Codificação</span><span class="sxs-lookup"><span data-stu-id="ef6c9-517">Fixed bug in File.Save to not overload with Encoding Type</span></span>
* <span data-ttu-id="ef6c9-518">Problema https://github.com/Azure/azure-powershell/issues/6560 corrigido</span><span class="sxs-lookup"><span data-stu-id="ef6c9-518">Fixed issue https://github.com/Azure/azure-powershell/issues/6560</span></span>
    - <span data-ttu-id="ef6c9-519">Atualizado para a versão 4.0.3 do Nuget, que corrige a exceção de padrão em apiId</span><span class="sxs-lookup"><span data-stu-id="ef6c9-519">Upgraded to 4.0.3 Nuget version which fixes the pattern exception on apiId</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-520">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-520">AzureRM.Compute</span></span>
* <span data-ttu-id="ef6c9-521">Corrigido problema com a falha na criação de uma vm com DiskFileParameterSet em New-AzureRmVm devido a mudança de nome do tipo de conta de armazenamento PremiumLRS.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-521">Fix issue with creating a vm using DiskFileParameterSet in New-AzureRmVm failing because of PremiumLRS storage account type renaming.</span></span>
* <span data-ttu-id="ef6c9-522">Foi corrigido o cmdlet Invoke-AzureRmVMRunCommand</span><span class="sxs-lookup"><span data-stu-id="ef6c9-522">Fix Invoke-AzureRmVMRunCommand cmdlet</span></span>
* <span data-ttu-id="ef6c9-523">Foi atualizado Get-AzureRmAvailabilitySet para permitir a listagem de todos os conjuntos de disponibilidade numa subscrição.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-523">Update Get-AzureRmAvailabilitySet to enable list all availability sets in a subscription.</span></span>  <span data-ttu-id="ef6c9-524">(O parâmetro ResouceGroupName é agora opcional.)</span><span class="sxs-lookup"><span data-stu-id="ef6c9-524">(ResouceGroupName parameter is now optional.)</span></span>
* <span data-ttu-id="ef6c9-525">Atualização de SimpleParameterSet de “New-AzureRmVm” para permitir a Rede Acelerada em vms elegíveis.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-525">Update SimpleParameterSet of 'New-AzureRmVm' to enable Accelerated Network on qualifying vms.</span></span>
* <span data-ttu-id="ef6c9-526">Atualização do conjunto de parâmetros simples New-AzureRmVmss para falhar a criação de vms quando um LB especificado por um utilizador já existir.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-526">Update New-AzureRmVmss simple parameter set to fail creating the vmss when a user specified LB already exists.</span></span>
* <span data-ttu-id="ef6c9-527">Atualização de exemplo para New-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="ef6c9-527">Update example for New-AzureRmDisk</span></span>
* <span data-ttu-id="ef6c9-528">Adição de exemplo para “New-AzureRmVM”</span><span class="sxs-lookup"><span data-stu-id="ef6c9-528">Add example for 'New-AzureRmVM'</span></span>
* <span data-ttu-id="ef6c9-529">Atualização da descrição para Set-AzureRmVMOSDisk</span><span class="sxs-lookup"><span data-stu-id="ef6c9-529">Update description for Set-AzureRmVMOSDisk</span></span>
* <span data-ttu-id="ef6c9-530">Atualização do Exemplo 1 para Set-AzureRmVMBginfoExtension para corrigir a ortografia e o prefixo.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-530">Update Example 1 for Set-AzureRmVMBginfoExtension to correct spelling and prefix.</span></span> 

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="ef6c9-531">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="ef6c9-531">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="ef6c9-532">Atualização da versão do SDK .NET do ADF para a 1.1.0.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-532">Updated the ADF .Net SDK version to 1.1.0.</span></span>
* <span data-ttu-id="ef6c9-533">Suporte para partilha de runtime de integração autoalojado em várias fábricas de dados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-533">Support self-hosted integration runtime sharing across data factories.</span></span>
     - <span data-ttu-id="ef6c9-534">Adicionado parâmetro novo -SharedIntegrationRuntimeResourceId ao cmdlet Set-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-534">Add new parameter -SharedIntegrationRuntimeResourceId to Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>
     - <span data-ttu-id="ef6c9-535">Adicionado o parâmetro opcional novo -LinkedDataFactoryName ao cmdlet Remove-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-535">Add new optional parameter -LinkedDataFactoryName to Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="ef6c9-536">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ef6c9-536">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="ef6c9-537">Atualizada a versão do SDK DataPlane (Microsoft.Azure.DataLake.Store) para a 1.1.9</span><span class="sxs-lookup"><span data-stu-id="ef6c9-537">Updated the DataPlane SDK (Microsoft.Azure.DataLake.Store) version to 1.1.9</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="ef6c9-538">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="ef6c9-538">AzureRM.EventHub</span></span>
* <span data-ttu-id="ef6c9-539">Atualização de piping para InputObject e ResourceId em cmdlets de remoção</span><span class="sxs-lookup"><span data-stu-id="ef6c9-539">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="ef6c9-540">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="ef6c9-540">AzureRM.Insights</span></span>
* <span data-ttu-id="ef6c9-541">Correção da formatação de OutputType nos ficheiros de ajuda</span><span class="sxs-lookup"><span data-stu-id="ef6c9-541">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="ef6c9-542">Utilização da pré-visualização do SDK Microsoft.Azure.Management.Monitor SDK 0.19.1</span><span class="sxs-lookup"><span data-stu-id="ef6c9-542">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="ef6c9-543">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ef6c9-543">AzureRM.KeyVault</span></span>
* <span data-ttu-id="ef6c9-544">Correção de problema em Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="ef6c9-544">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="ef6c9-545">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="ef6c9-545">AzureRM.Network</span></span>
* <span data-ttu-id="ef6c9-546">Adicionados exemplos para os cmdlets LoadBalancerInboundNatPoolConfig.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-546">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="ef6c9-547">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="ef6c9-547">AzureRM.Resources</span></span>
* <span data-ttu-id="ef6c9-548">Corrigido problema ao fornecer o nome e o valor da etiqueta para “Get-AzureRmResource”</span><span class="sxs-lookup"><span data-stu-id="ef6c9-548">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="ef6c9-549">Correção de cenário de piping com “Set-AzureRmResource”</span><span class="sxs-lookup"><span data-stu-id="ef6c9-549">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="ef6c9-550">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="ef6c9-550">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="ef6c9-551">Atualização de piping para InputObject e ResourceId em cmdlets de remoção</span><span class="sxs-lookup"><span data-stu-id="ef6c9-551">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="ef6c9-552">corrigidos problemas novos</span><span class="sxs-lookup"><span data-stu-id="ef6c9-552">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="ef6c9-553">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-553">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-554">Adição de suporte para Proteção Avançada contra Ameaças do Servidor com os seguintes cmdlets:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-554">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="ef6c9-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="ef6c9-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="ef6c9-556">Adição de suporte para Avaliação de Vulnerabilidades com os seguintes cmdlets:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-556">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="ef6c9-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="ef6c9-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="ef6c9-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="ef6c9-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="ef6c9-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="ef6c9-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="ef6c9-560">Corrigido exemplo em Remove-AzureRmSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="ef6c9-560">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="ef6c9-561">Corrigido processamento incorreto de datetime para culturas base diferentes de eua em Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="ef6c9-561">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="ef6c9-562">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-562">AzureRM.Storage</span></span>
* <span data-ttu-id="ef6c9-563">Adição de Ps1XmlAttribute para propriedades de tipos de saídas de cmdlets</span><span class="sxs-lookup"><span data-stu-id="ef6c9-563">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="ef6c9-564">Mostrar saída de cmdlet StorageAccount na vista de tabela</span><span class="sxs-lookup"><span data-stu-id="ef6c9-564">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="ef6c9-565">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="ef6c9-565">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="ef6c9-566">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="ef6c9-566">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="ef6c9-567">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="ef6c9-567">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="ef6c9-568">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="ef6c9-568">AzureRM.Tags</span></span>
* <span data-ttu-id="ef6c9-569">Remoção de declaração incorreta da ajuda do cmdlet Tag</span><span class="sxs-lookup"><span data-stu-id="ef6c9-569">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="ef6c9-570">6.5.0 - Julho de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-570">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="ef6c9-571">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-571">AzureRM.Profile</span></span>
* <span data-ttu-id="ef6c9-572">Ajuda atualizada para "Get-AzureRmContextAutosaveSetting"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-572">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="ef6c9-573">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-573">Azure.Storage</span></span>
* <span data-ttu-id="ef6c9-574">Suporte de Carregamento de Blob ou Ficheiro com token Sas apenas de escrita</span><span class="sxs-lookup"><span data-stu-id="ef6c9-574">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="ef6c9-575">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="ef6c9-575">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="ef6c9-576">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="ef6c9-576">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="ef6c9-577">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="ef6c9-577">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="ef6c9-578">Adicionar propriedade ResourceGroupName obrigatória ao AS.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-578">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="ef6c9-579">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="ef6c9-579">AzureRM.Automation</span></span>
* <span data-ttu-id="ef6c9-580">Atualizar ajuda e adicionar exemplo a "New-AzureRMAutomationSchedule"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-580">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-581">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-581">AzureRM.Compute</span></span>
* <span data-ttu-id="ef6c9-582">Adicionar parâmetro -Tag a Update/New-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="ef6c9-582">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="ef6c9-583">Adicionar exemplo a "Add-AzureRmVmssExtension"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-583">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="ef6c9-584">Adicionar exemplos a "Remove-AzureRmVmssExtension"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-584">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="ef6c9-585">Atualizar ajuda para "Set-AzureRmVMAccessExtension"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-585">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="ef6c9-586">Atualizar SimpleParameterSet para New-AzureRmVmss para definir SinglePlacementGroup como falso por predefinição e adicionar parâmetro do comutador "SinglePlacementGroup" que permite ao utilizador criar a VMSS num único grupo de posicionamento.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-586">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="ef6c9-587">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="ef6c9-587">AzureRM.EventHub</span></span>
* <span data-ttu-id="ef6c9-588">Adicionada uma propriedade só de leitura "PendingReplicationOperationsCount" à classe PSEventHubDRConfigurationAttributes, o que concede a contagem de operações de replicação pendente enquanto está em curso</span><span class="sxs-lookup"><span data-stu-id="ef6c9-588">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="ef6c9-589">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ef6c9-589">AzureRM.KeyVault</span></span>
* <span data-ttu-id="ef6c9-590">Atualizar mensagem de erro para Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="ef6c9-590">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="ef6c9-591">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="ef6c9-591">AzureRM.LogicApp</span></span>
* <span data-ttu-id="ef6c9-592">Erro "a definição do parâmetro não foi resolvida" corrigido no New-AzureRmLogicApp</span><span class="sxs-lookup"><span data-stu-id="ef6c9-592">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="ef6c9-593">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="ef6c9-593">AzureRM.Network</span></span>
* <span data-ttu-id="ef6c9-594">Ativar peering entre várias Redes Virtuais em vários Inquilinos para Set/Add-AzureRmVirtualNetworkPeering</span><span class="sxs-lookup"><span data-stu-id="ef6c9-594">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="ef6c9-595">Cmdlets abaixo atualizados para Gateway de Aplicação</span><span class="sxs-lookup"><span data-stu-id="ef6c9-595">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="ef6c9-596">New-AzureRmApplicationGateway: Sinalizador EnableFIPS e suporte de Zonas adicionados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-596">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="ef6c9-597">New-AzureRmApplicationGatewaySku: novos skus Standard_v2 e WAF_v2 adicionados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-597">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="ef6c9-598">Set-AzureRmApplicationGatewaySku: novos skus Standard_v2 e WAF_v2 adicionados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-598">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="ef6c9-599">Cmdlets RouteTable regenerados com a versão do gerador mais recente</span><span class="sxs-lookup"><span data-stu-id="ef6c9-599">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="ef6c9-600">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="ef6c9-600">AzureRM.Relay</span></span>
* <span data-ttu-id="ef6c9-601">Ficheiros de marcação atualizados, correção para o problema do nome do parâmetro no exemplo</span><span class="sxs-lookup"><span data-stu-id="ef6c9-601">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="ef6c9-602">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="ef6c9-602">AzureRM.Resources</span></span>
* <span data-ttu-id="ef6c9-603">Cmdlets Roleassignment e roledefinition atualizados:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-603">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="ef6c9-604">Remover chamadas de roledefinition extra feitas como parte da paginação.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-604">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="ef6c9-605">Corrigir cmdlet Get-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="ef6c9-605">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="ef6c9-606">Corrigir funcionalidade do parâmetro do comando -ExpandPrincipalGroups</span><span class="sxs-lookup"><span data-stu-id="ef6c9-606">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="ef6c9-607">Corrigir problema com "Get-AzureRmResource" em que o parâmetro "-ResourceType" era sensível a maiúsculas e minúsculas</span><span class="sxs-lookup"><span data-stu-id="ef6c9-607">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="ef6c9-608">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="ef6c9-608">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="ef6c9-609">Parâmetro top e skip adicionados para listar os cmdlets</span><span class="sxs-lookup"><span data-stu-id="ef6c9-609">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="ef6c9-610">Cmdlets de migração do Espaço de Nomes Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-610">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="ef6c9-611">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-611">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="ef6c9-612">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-612">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="ef6c9-613">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-613">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="ef6c9-614">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-614">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="ef6c9-615">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-615">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="ef6c9-616">Adicionada uma propriedade só de leitura "PendingReplicationOperationsCount" à classe PSServiceBusDRConfigurationAttributes, o que concede a contagem de operações de replicação pendente enquanto está em curso</span><span class="sxs-lookup"><span data-stu-id="ef6c9-616">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="ef6c9-617">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ef6c9-617">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="ef6c9-618">Exemplo de atualização para "New-AzureRmServiceFabricCluster"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-618">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="ef6c9-619">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-619">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-620">Adicionar novos Cmdlets ao Management.Sql para permitir aos clientes adicionarem o Certificado TDE à instância do Sql Server ou uma Instância Gerida</span><span class="sxs-lookup"><span data-stu-id="ef6c9-620">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="ef6c9-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="ef6c9-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="ef6c9-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="ef6c9-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-623">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-623">AzureRM.Websites</span></span>
* <span data-ttu-id="ef6c9-624">`Set-AzureRmWebApp -AssignIdentity` e  `Set-AzureRmWebAppSlot -AssignIdentity` quando definidos como falso também irão agora remover a propriedade de Identidade da etiqueta de pré-visualização object.Removing do site.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-624">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="ef6c9-625">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` exemplo atualizado</span><span class="sxs-lookup"><span data-stu-id="ef6c9-625">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="ef6c9-626">`Set-AzureRmWebApp -PhpVersion` suporta como uma versão válida do PHP</span><span class="sxs-lookup"><span data-stu-id="ef6c9-626">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="ef6c9-627">6.4.0 - julho de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-627">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="ef6c9-628">Geral</span><span class="sxs-lookup"><span data-stu-id="ef6c9-628">General</span></span>
* <span data-ttu-id="ef6c9-629">Correção da formatação de OutputType nos ficheiros de ajuda para a maioria dos módulos</span><span class="sxs-lookup"><span data-stu-id="ef6c9-629">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="ef6c9-630">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-630">AzureRM.Profile</span></span>
* <span data-ttu-id="ef6c9-631">Foi adicionado o atributo Ps1Xml aos tipos de saída básicos</span><span class="sxs-lookup"><span data-stu-id="ef6c9-631">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-632">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-632">AzureRM.Compute</span></span>
* <span data-ttu-id="ef6c9-633">Funcionalidade de Etiqueta IP para VMSS</span><span class="sxs-lookup"><span data-stu-id="ef6c9-633">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="ef6c9-634">Foi adicionado o cmdlet "New-AzureRmVmssIpTagConfig"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-634">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="ef6c9-635">Foi adicionado o parâmetro IpTag a New-AzureRmVmssIpConfig</span><span class="sxs-lookup"><span data-stu-id="ef6c9-635">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="ef6c9-636">Funcionalidade de Reversão do SO automática para VMSS</span><span class="sxs-lookup"><span data-stu-id="ef6c9-636">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="ef6c9-637">Foram adicionados parâmetros DisableAutoRollback a New-AzureRmVmssConfig e Update-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-637">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="ef6c9-638">Funcionalidade de Histórico de Atualização do SO para Vmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-638">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="ef6c9-639">Foi adicionado o parâmetro OSUpgradeHistory a Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-639">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="ef6c9-640">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="ef6c9-640">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="ef6c9-641">Adição de suporte para ACLs de Catálogo através dos seguintes comandos:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-641">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="ef6c9-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="ef6c9-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="ef6c9-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="ef6c9-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="ef6c9-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="ef6c9-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="ef6c9-645">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ef6c9-645">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="ef6c9-646">Adição de suporte ao cancelamento e de controlo do progresso para Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry e Set-AzureRmDataLakeStoreItemAcl</span><span class="sxs-lookup"><span data-stu-id="ef6c9-646">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="ef6c9-647">Adição de suporte ao cancelamento para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="ef6c9-647">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="ef6c9-648">Correção da remoção de mensagens de depuração para cmdlets que realizam operações recursivas</span><span class="sxs-lookup"><span data-stu-id="ef6c9-648">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="ef6c9-649">Correção da localização de teste de cmdlets do DataLake</span><span class="sxs-lookup"><span data-stu-id="ef6c9-649">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="ef6c9-650">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="ef6c9-650">AzureRM.EventHub</span></span>
* <span data-ttu-id="ef6c9-651">Adição do parâmetro Optional MaxCount aos cmdlets Get-AzureRmEventHub e Get-AzureRmEventHubConsumerGroup de List Operations</span><span class="sxs-lookup"><span data-stu-id="ef6c9-651">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="ef6c9-652">Correção de problema no cmdlet New-AzureRmEventHub, no qual era necessário, pelo menos, um parâmetro durante a criação de um novo EventHub.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-652">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="ef6c9-653">Conjunto de Parâmetros Predefinidos fornecido.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-653">Provided Default Parameter set.</span></span>
* <span data-ttu-id="ef6c9-654">Adição de Parâmetro opcional -KeyValue ao cmdlet New-AzureRmEventHubKey, o que permite ao utilizador fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-654">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="ef6c9-655">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ef6c9-655">AzureRM.KeyVault</span></span>
* <span data-ttu-id="ef6c9-656">Correção de problema no qual todos os recursos eram devolvidos por Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="ef6c9-656">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="ef6c9-657">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="ef6c9-657">AzureRM.Network</span></span>
* <span data-ttu-id="ef6c9-658">Apresentação de novos SKUs para VirtualNetworkGateways com redundância entre zonas</span><span class="sxs-lookup"><span data-stu-id="ef6c9-658">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="ef6c9-659">Adição de novos comandos para a funcionalidade: APIs de Parceiro do ExpressRoute via ARM</span><span class="sxs-lookup"><span data-stu-id="ef6c9-659">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="ef6c9-660">Adição de Get-AzureRmExpressRouteCrossConnection</span><span class="sxs-lookup"><span data-stu-id="ef6c9-660">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="ef6c9-661">Adição de Set-AzureRmExpressRouteCrossConnection</span><span class="sxs-lookup"><span data-stu-id="ef6c9-661">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="ef6c9-662">Adição de Add-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="ef6c9-662">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="ef6c9-663">Adição de Get-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="ef6c9-663">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="ef6c9-664">Adição de Remove-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="ef6c9-664">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="ef6c9-665">Adição de Get-AzureRMExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="ef6c9-665">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="ef6c9-666">Adição de Get-AzureRMExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="ef6c9-666">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="ef6c9-667">Adição de Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="ef6c9-667">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="ef6c9-668">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="ef6c9-668">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="ef6c9-669">Adição do cmdlet Get-AzureRmRecoveryServicesBackupStatus.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-669">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="ef6c9-670">Este cmdlet vai buscar um ID da VM e verifica se a VM está protegida por algum cofre na subscrição.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-670">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="ef6c9-671">Se o cofre existir, o cmdlet devolve os detalhes do cofre.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-671">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="ef6c9-672">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="ef6c9-672">AzureRM.Resources</span></span>
* <span data-ttu-id="ef6c9-673">Atualização de cmdlets Get-AzureRmPolicyAssignment:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-673">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="ef6c9-674">Adição de suporte para a listagem de valores -Scope ao nível do grupo de gestão</span><span class="sxs-lookup"><span data-stu-id="ef6c9-674">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="ef6c9-675">Adição de suporte para a obtenção de atribuições individuais com valores -Scope ao nível do grupo de gestão</span><span class="sxs-lookup"><span data-stu-id="ef6c9-675">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="ef6c9-676">Adição de parâmetros -Effective e -All ao parâmetro de controlo</span><span class="sxs-lookup"><span data-stu-id="ef6c9-676">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="ef6c9-677">Atualização dos cmdlets Get/New/Remove/Set-AzureRmPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="ef6c9-677">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="ef6c9-678">Adição do parâmetro -ManagementGroupName para aplicar operações a um determinado grupo de gestão</span><span class="sxs-lookup"><span data-stu-id="ef6c9-678">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="ef6c9-679">Adição do parâmetro -SubscriptionId para aplicar operações a uma determinada subscrição</span><span class="sxs-lookup"><span data-stu-id="ef6c9-679">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="ef6c9-680">Atualização dos cmdlets Get/New/Remove/Set-AzureRmPolicySetDefinition</span><span class="sxs-lookup"><span data-stu-id="ef6c9-680">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="ef6c9-681">Adição do parâmetro -ManagementGroupName para aplicar operações a um determinado grupo de gestão</span><span class="sxs-lookup"><span data-stu-id="ef6c9-681">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="ef6c9-682">Adição do parâmetro -SubscriptionId para aplicar operações a uma determinada subscrição</span><span class="sxs-lookup"><span data-stu-id="ef6c9-682">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="ef6c9-683">Adição de suporte de referência de segredo do KeyVault nos parâmetros ao utilizar "TemplateParameterObject" em "New-AzureRmResourceGroupDeployment"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-683">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="ef6c9-684">Correção de problema em que o parâmetro "-EndDate" era ignorado para "New-AzureRmADAppCredential"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-684">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="ef6c9-685">Correção de problema em que "Add-AzureRmADGroupMember" utilizava o URL incorreto para fazer o pedido</span><span class="sxs-lookup"><span data-stu-id="ef6c9-685">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="ef6c9-686">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="ef6c9-686">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="ef6c9-687">Adição de Parâmetro opcional -KeyValue ao cmdlet New-AzureRmServiceBusKey, o que permite ao utilizador fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-687">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="ef6c9-688">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-688">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-689">Esclarecimento dos Pontos de Restauro Definidos pelo Utilizador para SQLDW na ajuda de New-AzureRmSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="ef6c9-689">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="ef6c9-690">Atualização da documentação do parâmetro -ComputeGeneration em vários cmdlets</span><span class="sxs-lookup"><span data-stu-id="ef6c9-690">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="ef6c9-691">6.3.0 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-691">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="ef6c9-692">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-692">AzureRM.Profile</span></span>
* <span data-ttu-id="ef6c9-693">Atualização das mensagens de erro de Enable-AzureRmContextAutoSave</span><span class="sxs-lookup"><span data-stu-id="ef6c9-693">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="ef6c9-694">Criação de contexto para cada subscrição ao executar "Connect-AzureRmAccount" sem contexto anterior</span><span class="sxs-lookup"><span data-stu-id="ef6c9-694">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="ef6c9-695">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-695">Azure.Storage</span></span>
* <span data-ttu-id="ef6c9-696">Adição de outras informações sobre o parâmetro -Permissions nos ficheiros de ajuda.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-696">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-697">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-697">AzureRM.Compute</span></span>
* <span data-ttu-id="ef6c9-698">"Get-AzureRmVmDiskEncryptionStatus" corrige um problema observado em VMs sem discos de dados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-698">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="ef6c9-699">Atualização da versão da biblioteca de cliente de Computação para corrigir os seguintes cmdlets</span><span class="sxs-lookup"><span data-stu-id="ef6c9-699">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="ef6c9-700">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="ef6c9-700">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="ef6c9-701">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="ef6c9-701">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="ef6c9-702">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="ef6c9-702">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="ef6c9-703">Correção dos seguintes cmdlets para mostrar o "ID da operação" e o "estado da operação" corretamente:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-703">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="ef6c9-704">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="ef6c9-704">Start-AzureRmVM</span></span>
    - <span data-ttu-id="ef6c9-705">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="ef6c9-705">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="ef6c9-706">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="ef6c9-706">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="ef6c9-707">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="ef6c9-707">Set-AzureRmVM</span></span>
    - <span data-ttu-id="ef6c9-708">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="ef6c9-708">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="ef6c9-709">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-709">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="ef6c9-710">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="ef6c9-710">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="ef6c9-711">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="ef6c9-711">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="ef6c9-712">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-712">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="ef6c9-713">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-713">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="ef6c9-714">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-714">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="ef6c9-715">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="ef6c9-715">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="ef6c9-716">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="ef6c9-716">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="ef6c9-717">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="ef6c9-717">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="ef6c9-718">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="ef6c9-718">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="ef6c9-719">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="ef6c9-719">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="ef6c9-720">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="ef6c9-720">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="ef6c9-721">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="ef6c9-721">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="ef6c9-722">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="ef6c9-722">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="ef6c9-723">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="ef6c9-723">AzureRM.EventGrid</span></span>
* <span data-ttu-id="ef6c9-724">Remoção das condições de validação ValidateNotNullOrEmpty para SubjectBeginsWith/SubjectEndsWith no cmdlet Update-AzureRmEventGridSubscription para permitir a alteração destes parâmetros para uma cadeia vazia, se necessário.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-724">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="ef6c9-725">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ef6c9-725">AzureRM.KeyVault</span></span>
* <span data-ttu-id="ef6c9-726">Correção de problema em que não são devolvidas Etiquetas quando Get-AzureRmKeyVault -Tag é executado</span><span class="sxs-lookup"><span data-stu-id="ef6c9-726">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="ef6c9-727">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="ef6c9-727">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="ef6c9-728">Disponibilização pública de cmdlets de Informações de Política</span><span class="sxs-lookup"><span data-stu-id="ef6c9-728">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="ef6c9-729">Utilização da versão da API 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="ef6c9-729">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="ef6c9-730">Adição de PolicyDefinitionReferenceId aos resultados de Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="ef6c9-730">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="ef6c9-731">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="ef6c9-731">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="ef6c9-732">Adição do parâmetro -Vault a cmdlets RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-732">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="ef6c9-733">Ao ser transmitido, substitui o cmdlet Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-733">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="ef6c9-734">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-734">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-735">Atualização de exemplo no ficheiro de ajuda para Get-AzureRmSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="ef6c9-735">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="ef6c9-736">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="ef6c9-736">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="ef6c9-737">Atualização do ficheiro de ajuda para Add-AzureRmTrafficManagerEndpointConfig</span><span class="sxs-lookup"><span data-stu-id="ef6c9-737">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-738">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-738">AzureRM.Websites</span></span>
* <span data-ttu-id="ef6c9-739">Atualização de "Set-AzureRmWebApp" de modo a não substituir AppSettings quando -AssignIdentity é utilizado</span><span class="sxs-lookup"><span data-stu-id="ef6c9-739">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="ef6c9-740">Atualização de "New-AzureRmWebAppSlot" de modo a honrar AppServicePlan como um parâmetro opcional</span><span class="sxs-lookup"><span data-stu-id="ef6c9-740">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="ef6c9-741">6.2.1 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-741">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="ef6c9-742">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="ef6c9-742">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="ef6c9-743">Atualização do modelo de PSWorkspace para permitir que a Rede utilize o tipo como um parâmetro</span><span class="sxs-lookup"><span data-stu-id="ef6c9-743">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="ef6c9-744">6.2.0 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-744">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="ef6c9-745">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-745">AzureRM.Profile</span></span>
* <span data-ttu-id="ef6c9-746">Corrija o problema onde a versão 10.0.3 de Newtonsoft.Json não foi carregada na importação do módulo</span><span class="sxs-lookup"><span data-stu-id="ef6c9-746">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="ef6c9-747">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="ef6c9-747">AzureRM.Compute</span></span>
* <span data-ttu-id="ef6c9-748">Funcionalidade Atualização da VM VMSS</span><span class="sxs-lookup"><span data-stu-id="ef6c9-748">VMSS VM Update feature</span></span>
    - <span data-ttu-id="ef6c9-749">Cmdlets "Update-AzureRmVmssVM" e "New-AzureRmVMDataDisk" adicionados</span><span class="sxs-lookup"><span data-stu-id="ef6c9-749">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="ef6c9-750">Adicione o parâmetro VirtualMachineScaleSetVM ao cmdlet "Add-AzureRmVMDataDisk" para suportar a adição de um disco de dados à VM Vmss.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-750">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="ef6c9-751">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="ef6c9-751">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="ef6c9-752">O SDK de .Net do ADF foi atualizado para a versão 0.8.0-preview que contém as seguintes alterações:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-752">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="ef6c9-753">Foi adicionada a operação de Configuração de fábrica do repositório</span><span class="sxs-lookup"><span data-stu-id="ef6c9-753">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="ef6c9-754">QuickBooks LinkedService atualizado para expor as propriedades consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="ef6c9-754">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="ef6c9-755">Vários tipos de modelos Atualizados de SecretBase para Object</span><span class="sxs-lookup"><span data-stu-id="ef6c9-755">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="ef6c9-756">Acionador de Eventos de Blob adicionado</span><span class="sxs-lookup"><span data-stu-id="ef6c9-756">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="ef6c9-757">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ef6c9-757">AzureRM.KeyVault</span></span>
* <span data-ttu-id="ef6c9-758">Documentação de atualização com resultado de exemplo</span><span class="sxs-lookup"><span data-stu-id="ef6c9-758">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="ef6c9-759">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="ef6c9-759">AzureRM.Network</span></span>
* <span data-ttu-id="ef6c9-760">Ativar parâmetros da Análise de Tráfego em cmdlets do Observador de Rede</span><span class="sxs-lookup"><span data-stu-id="ef6c9-760">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="ef6c9-761">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="ef6c9-761">AzureRM.Resources</span></span>
* <span data-ttu-id="ef6c9-762">Corrija o problema com a propriedade "Propriedades" do(s) objeto(s) "PSResource" devolvidos por "Get-AzureRmResource"</span><span class="sxs-lookup"><span data-stu-id="ef6c9-762">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="ef6c9-763">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="ef6c9-763">AzureRM.Scheduler</span></span>
* <span data-ttu-id="ef6c9-764">Corrija o problema com a atualização ServiceBusQueueJob sem definir novos valores de Autenticação</span><span class="sxs-lookup"><span data-stu-id="ef6c9-764">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="ef6c9-765">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-765">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-766">Cmdlets seguintes atualizados com parâmetro opcional LicenseType</span><span class="sxs-lookup"><span data-stu-id="ef6c9-766">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="ef6c9-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="ef6c9-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="ef6c9-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="ef6c9-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="ef6c9-769">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="ef6c9-769">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="ef6c9-770">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="ef6c9-770">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="ef6c9-771">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="ef6c9-771">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="ef6c9-772">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="ef6c9-772">AzureRM.Websites</span></span>
* <span data-ttu-id="ef6c9-773">"New-AzureRMWebApp" está atualizado para utilizar algoritmos comuns da biblioteca Estratégia.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-773">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="ef6c9-774">6.1.0 - Maio de 2018</span><span class="sxs-lookup"><span data-stu-id="ef6c9-774">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="ef6c9-775">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="ef6c9-775">AzureRM.Profile</span></span>
* <span data-ttu-id="ef6c9-776">Correção do problema em que a execução de "Clear-AzureRmContext" mantinha um contexto vazio com o nome do contexto predefinido anterior, o que impedia o utilizador de criar um novo contexto com o nome antigo</span><span class="sxs-lookup"><span data-stu-id="ef6c9-776">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="ef6c9-777">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="ef6c9-777">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="ef6c9-778">Permitir operações de associação/desassociação do Gateway no AS.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-778">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="ef6c9-779">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="ef6c9-779">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="ef6c9-780">Foi adicionado suporte para ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="ef6c9-780">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="ef6c9-781">Foi adicionado suporte para o Back-end do ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ef6c9-781">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="ef6c9-782">Foi adicionado suporte para o Logger do Application Insights</span><span class="sxs-lookup"><span data-stu-id="ef6c9-782">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="ef6c9-783">Foi adicionado suporte para reconhecer o SKU "Básico" como um SKU válido do serviço Gestão de API</span><span class="sxs-lookup"><span data-stu-id="ef6c9-783">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="ef6c9-784">Foi adicionado suporte para instalar Certificados emitidos por AC privadas como Raiz ou AC</span><span class="sxs-lookup"><span data-stu-id="ef6c9-784">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="ef6c9-785">Foi adicionado suporte para aceitar Certificados SSL personalizados através do KeyVault e de vários nomes de anfitrião de proxy</span><span class="sxs-lookup"><span data-stu-id="ef6c9-785">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="ef6c9-786">Foi adicionado suporte para a identidade MSI</span><span class="sxs-lookup"><span data-stu-id="ef6c9-786">Added support for MSI identity</span></span>
* <span data-ttu-id="ef6c9-787">Foi adicionado suporte para aceitar políticas através de Url. NOTA: Os cmdlets seguintes serão preteridos numa versão futura</span><span class="sxs-lookup"><span data-stu-id="ef6c9-787">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="ef6c9-788">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="ef6c9-788">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="ef6c9-789">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-789">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="ef6c9-790">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="ef6c9-790">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="ef6c9-791">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="ef6c9-791">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="ef6c9-792">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="ef6c9-792">AzureRM.Batch</span></span>
* <span data-ttu-id="ef6c9-793">Lançamento do novo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="ef6c9-793">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="ef6c9-794">Lançamento do novo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="ef6c9-794">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="ef6c9-795">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="ef6c9-795">AzureRM.Consumption</span></span>
* <span data-ttu-id="ef6c9-796">Adição dos novos parâmetros Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top no Cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="ef6c9-796">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="ef6c9-797">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ef6c9-797">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="ef6c9-798">Correção do exemplo de Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="ef6c9-798">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="ef6c9-799">Correção da exceção do parâmetro nulo do caso Recursivo em Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="ef6c9-799">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="ef6c9-800">Correção dos ficheiros de ajuda de Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="ef6c9-800">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="ef6c9-801">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="ef6c9-801">AzureRM.Network</span></span>
* <span data-ttu-id="ef6c9-802">Aumento da versão do SDK de Rede de 18.0.0-preview para 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="ef6c9-802">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="ef6c9-803">Foi adicionado um cmdlet para criar a configuração de protocolo</span><span class="sxs-lookup"><span data-stu-id="ef6c9-803">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="ef6c9-804">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="ef6c9-804">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="ef6c9-805">Foi adicionado um cmdlet para adicionar uma nova ligação de circuito a um circuito existente do ExpressRoute.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-805">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="ef6c9-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="ef6c9-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="ef6c9-807">Foi adicionado um cmdlet para remover uma ligação de circuito de um circuito existente do ExpressRoute.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-807">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="ef6c9-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="ef6c9-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="ef6c9-809">Foi adicionado um cmdlet para obter uma ligação de circuito</span><span class="sxs-lookup"><span data-stu-id="ef6c9-809">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="ef6c9-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="ef6c9-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="ef6c9-811">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ef6c9-811">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="ef6c9-812">Correção da utilização da autenticação de servidor com certificados gerados (Problema #5998)</span><span class="sxs-lookup"><span data-stu-id="ef6c9-812">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="ef6c9-813">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="ef6c9-813">AzureRM.Sql</span></span>
* <span data-ttu-id="ef6c9-814">Atualização dos cmdlets de Auditoria para permitir a remoção de AuditActions ou AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="ef6c9-814">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="ef6c9-815">Correção do problema de Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy ao definir uma nova política de retenção flexível em que o comando falhava com "Configurar a política de retenção de longo-prazo com o cofre e a política do serviço de recuperação do Azure já não é suportado.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-815">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="ef6c9-816">Submeta um pedido com a nova política de retenção flexível".</span><span class="sxs-lookup"><span data-stu-id="ef6c9-816">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="ef6c9-817">Atualize todos os cmdlets relacionados com as Bases de Dados SQL do Azure/Criação de Conjuntos Elásticos/Atualização para utilizar a nova API de Base de Dados, que suporta a propriedade SKU para propriedades relacionadas com dimensionamento e escalão.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-817">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="ef6c9-818">Os cmdlets atualizados, incluindo:</span><span class="sxs-lookup"><span data-stu-id="ef6c9-818">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="ef6c9-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="ef6c9-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="ef6c9-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="ef6c9-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="ef6c9-821">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="ef6c9-821">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="ef6c9-822">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="ef6c9-822">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="ef6c9-823">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="ef6c9-823">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="ef6c9-824">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="ef6c9-824">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="ef6c9-825">Atualize os parâmetros de "Get-AzureRmTrafficManagerProfile" para que o parâmetro -ResourceGroupName seja necessário ao utilizar o parâmetro -Name.</span><span class="sxs-lookup"><span data-stu-id="ef6c9-825">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
