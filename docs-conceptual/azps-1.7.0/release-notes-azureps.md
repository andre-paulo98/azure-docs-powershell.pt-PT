...
* Correção do problema de encaminhamento do resultado de `Get-AzResource` para `Set-AzResource`
    - Obtenha mais informações aqui: https://github.com/Azure/azure-powershell/issues/8240
* Correção do problema na alteração do tipo de dados JSON ao executar `Set-AzResource`
