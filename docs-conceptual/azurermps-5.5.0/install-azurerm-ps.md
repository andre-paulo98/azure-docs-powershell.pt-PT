...
Se quiser utilizar o Azure PowerShell no macOS ou no Linux, veja o seguinte artigo:  
[Instalar e configurar o Azure PowerShell no macOS e Linux](install-azurermps-maclinux.md).
...
```
Além disso, pode querer atualizar o PowerShellGet com o comando abaixo:
```powershell
...
|Quero atualizar para o PowerShell 5|<ol><li>[Instalar a versão mais recente do WMF](https://www.microsoft.com/en-us/download/details.aspx?id=54616)</li><li>Execute o seguinte comando:<br/>```Install-Module PowerShellGet -Force```</li></ol>|
|Estou a executar uma versão do Windows com o PowerShell 3 ou o PowerShell 4|<ol><il>[Obter os módulos PackageManagement](http://go.microsoft.com/fwlink/?LinkID=746217)</il><li>Execute o seguinte comando:<br/>```Install-Module PowerShellGet -Force```</li></ol>|
