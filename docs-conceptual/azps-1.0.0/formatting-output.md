...
Neste exemplo obtemos uma lista de VMs do Azure na nossa subscrição predefinida.  O comando `Get-AzVM` predefine a saída para um formato de tabela.
