...
* Mensagens de erro atualizado para Enable-AzureRmContextAutoSave
* Criar um contexto para cada subscrição ao executar "Connect-AzureRmAccount" sem contexto anterior

#### <a name="azurestorage"></a>Azure.Storage
* Outras informações adicionadas sobre o parâmetro -Permissions nos ficheiros de ajuda.

#### <a name="azurermcompute"></a>AzureRM.Compute
* O "Get-AzureRmVmDiskEncryptionStatus" corrige um problema observado para VMs sem discos de dados 
* Atualizar versão da biblioteca de cliente de Computação para corrigir os seguintes cmdlets
    - Grant-AzureRmDiskAccess
    - Grant-AzureRmSnapshotAccess
    - Save-AzureRmVMImage
* Os seguintes cmdlets foram corrigidos para mostrar o "ID da operação" e o "estado da operação" corretamente:
    - Start-AzureRmVM
    - Stop-AzureRmVM
    - Restart-AzureRmVM
    - Set-AzureRmVM
...
* Remova as condições de validação ValidateNotNullOrEmpty para SubjectBeginsWith/SubjectEndsWith no cmdlet Update-AzureRmEventGridSubscription para permitir a alteração destes parâmetros para cadeia vazia, se for preciso.

#### <a name="azurermkeyvault"></a>AzureRM.KeyVault
* Corrigir problema quando não forem devolvidas Etiquetas quando o Get-AzureRmKeyVault-Tag for executado

#### <a name="azurermpolicyinsights"></a>AzureRM.PolicyInsights
* Lançamento público de cmdlets de informações de Política
    - Utilizar versão da API 2018-04-04
    - Adicione PolicyDefinitionReferenceId aos resultados do Get-AzureRmPolicyStateSummary

#### <a name="azurermrecoveryservicesbackup"></a>AzureRM.RecoveryServices.Backup
* Parâmetro -Vault adicionado aos cmdlets RecoveryServices.Backup. Quando for passado, isto irá substituir o cmdlet Set-AzureRmRecoveryServicesContext.

#### <a name="azurermsql"></a>AzureRM.Sql
* Exemplo atualizado no ficheiro de ajuda de Get-AzureRmSqlDatabaseExpanded

#### <a name="azurermtrafficmanager"></a>AzureRM.TrafficManager
* Ficheiro de ajuda atualizado para Add-AzureRmTrafficManagerEndpointConfig

#### <a name="azurermwebsites"></a>AzureRM.Websites
* "Set-AzureRmWebApp" está atualizado para não substituir o AppSettings ao utilizar o -AssignIdentity
* "New-AzureRmWebAppSlot" está atualizado para honrar o AppServicePlan como um parâmetro opcional

## <a name="621---june-2018"></a>6.2.1 - junho de 2018
### <a name="azurermoperationalinsights"></a>AzureRM.OperationalInsights
* Modelo do PSWorkspace atualizado para permitir que a Rede utilize o tipo como um parâmetro
