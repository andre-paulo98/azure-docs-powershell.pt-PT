...
O cmdlet `Get-AzApiManagementProperty` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.

### `New-AzApiManagementProperty`

O cmdlet `New-AzApiManagementProperty` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.

### `Remove-AzApiManagementProperty`

O cmdlet `Remove-AzApiManagementProperty` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.

### `Set-AzApiManagementProperty`

O cmdlet `Set-AzApiManagementProperty` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.
...
O cmdlet `Get-AzOperationalInsightsSavedSearchResult` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.

### `Get-AzOperationalInsightsSearchResult`

O cmdlet `Get-AzOperationalInsightsSearchResult` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.
...
O cmdlet `Get-AzOperationalInsightsLinkTarget` foi removido e não foi encontrado qualquer alias para o nome de cmdlet original.
